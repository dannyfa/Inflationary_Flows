...
@click.option('--disc',                    help='Discretization to use when simulating ODE', metavar='ifs|vp_ode',                                            type=click.Choice(['ifs', 'vp_ode']), default='ifs', show_default=True)
...
@click.option('--solver',                  help='Solver to use when simulating ODE', metavar='euler|heun',                                                    type=click.Choice(['euler', 'heun']), default='euler', show_default=True)
...
@click.option('--n_iters',                 help='Number of sampling steps', metavar='INT',                                                                    type=click.IntRange(min=1), default=1501, show_default=True)
...
@click.option('--device_name',             help='Name of device we wish to run simulation on.', metavar='STR',                                                type=str, default='cuda:1', show_default=True)
...
@click.option('--eps',                     help='Variance to be used when sampling compressed dims during PRR gen.', metavar='FLOAT',                         type=float, default=1e-7, show_default=True)
